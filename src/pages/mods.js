...
const COPY = {
  'zh-Hans': {
    ...
    player: '我是玩家', playerSteps: ['下载 Catapult v1.2.1-ccb 或更新版本，在“实验版 / 候选版”中选择 2026-09-07-2111。', '打开 MOD 标签，按 CCB 维护或民间维护筛选。查看适配信息后安装「猴王传承」0.4.1。四个旧示例已从公开目录下架。', '在游戏里创建新世界并启用选中的 MOD；安装不等于启用。按目录中的“怎么玩”选择「花果山行者」职业或六项变异，先用测试存档。'],
    ...
    status: '首版状态', statusText: '当前收录「猴王传承」0.4.1，作者和维护人均为 g1ytx，要求包含职业/变异引用修复的 CCB 2026-09-07-2111。金刚猿躯新增5%护甲结算前的可抵抗伤害减免（纯粹伤害等除外）。具体测试范围以目录记录为准；游戏内文本为简中，许可证未声明。不要用旧示例的验收记录判断本 MOD。',
  },
  en: {
    ...
    status: 'Version-one status', statusText: 'The catalog now features Monkey King Legacy 0.4.1, authored and maintained by g1ytx, requiring the profession/mutation fix in CCB 2026-09-07-2111. Diamond Ape Body now reduces resistible damage by 5% before armor (pure/no-resist damage excluded). Consult its catalog record for verification scope. In-game text is Chinese and the license is undeclared. Former example tests do not validate this MOD.',
  },
};
